...
p3=IF(AND('parent (?x) (?y)','male (?x)'),THEN('father (?x) (?y)'))

p4=IF(AND('parent (?x) (?y)','female (?x)'),THEN('mother (?x) (?y)'))

p5=IF(AND('parent (?x) (?y)','parent (?x) (?z)','male (?y)',NOT('same (?y) (?z)')),THEN('brother (?y) (?z)'))

p6=IF(AND('parent (?x) (?y)','parent (?x) (?z)','female (?y)',NOT('same (?y) (?z)')), THEN('sister (?y) (?z)'))

p7=IF(AND('parent (?x) (?y)','parent (?y) (?z)'), THEN('grandparent (?x) (?z)'))

p8=IF('grandparent (?x) (?y)' ,THEN('grandchild (?y) (?x)'))

p9=IF(AND('grandparent (?x) (?y)','grandparent (?x) (?z)',NOT('sister (?y) (?z)'),NOT('brother (?y) (?z)'),NOT('same (?z) (?y)')), THEN('cousin (?y) (?z)'))
...
# family_rules.
family_rules = [p00,p0,p1,p2,p3,p4,p5,p6,p7,p8,p9]                    # fill me in
